...
function loadKim(){
    ...
    var divScreen=$('#pomoc');
    divScreen.text('Nazywam się Przemysław Pawlak. Jestem studentem 3 roku Informatyki w Szkole Głównej Gospodarstwa Wiejskiego w Warszawie. Poza tym prowadzę gospodarstwo rolne. ');
...
function loadZainteresowania(){
    ...
    var divScreen=$('#pomoc');
    divScreen.html('<iframe width="100%" height="250" src="https://www.youtube.com/embed/DfGVqW-9QVE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>');
...
function loadKontakt(){
    ...
    var divScreen=$('#pomoc');
    divScreen.html('Email: s198723@sggw.edu.pl<br/>Telefon: 111-222-333 <br/><br/><br/> <div id="help2" style="text-align:right;"> <a href="#" class="fa fa-facebook"><a href="#" class="fa fa-google"></a> <a href="#" class="fa fa-linkedin"></a></div>');
